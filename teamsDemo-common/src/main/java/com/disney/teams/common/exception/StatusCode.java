...
public class StatusCode implements Serializable {
    ...
    //	访问拒绝
    public static final String CLIENT_ERROR_ACCESS_DENY_CODE = "0404";
    public static final StatusCode CLIENT_ERROR_ACCESS_DENY = new StatusCode(CLIENT_ERROR_ACCESS_DENY_CODE, "Access Deny");

    //	接口访问太频繁
    public static final String CLIENT_ERROR_ACCESS_TOO_FREQUENTLY_CODE = "0405";
